...
var _editPng = require("./images/edit.png");
var _editPngDefault = parcelHelpers.interopDefault(_editPng);
var _innerBgJpg = require("./images/inner_bg.jpg");
var _innerBgJpgDefault = parcelHelpers.interopDefault(_innerBgJpg);
...
class Game {
    ...
    <div class="name">Welcome ${this.name} <img class="editImg" alt="edit" src="${0, _editPngDefault.default}" width="24px" data-val="3" /></div>
    <div>
    ...
    displayScore() {
        ...
        let newArray = [];
        if (scoreArray.length < 5) newArray = [
            {
                name: this.name,
                score: this.level
            },
        ...
        else if (scoreArray[scoreArray.length - 1].score > this.level) newArray = scoreArray;
        else {
            scoreArray.pop();
            newArray = [
                {
    ...
    displayLeaderboard() {
        ...
        let scoreList = "";
        for(let i = 0; i < scoreArray.length; i++)scoreList += `<div style="font-size: 24px">${scoreArray[i].score}\u{1F389} ${scoreArray[i].name}</div>`;
        this.container.innerHTML = `
    ...
    handleMenuClick = (function(event) {
        switch(event.target.dataset?.val){
            case "1":
                document.body.style.background = `url(${0, _innerBgJpgDefault.default})`;
    ...
    handleNextNumber = (function() {
        if (this.displayedNumbers + 1 === this.level) this.displayInput(this.displayedInputs + 1 === this.level);
        else {
...
},{"./styles.css":"lW6qc","./images/edit.png":"ahczE","./images/inner_bg.jpg":"bif0W","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lW6qc":[function() {},{}],"ahczE":[function(require,module,exports) {
module.exports = require("d18922b95ec44fa6").getBundleURL("1XKra") + "edit.a68deb95.png" + "?" + Date.now();

},{"d18922b95ec44fa6":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}],"bif0W":[function(require,module,exports) {
module.exports = require("d03413251d6351c4").getBundleURL("1XKra") + "inner_bg.c974feb6.jpg" + "?" + Date.now();

},{"d03413251d6351c4":"lgJ39"}],"gkKU3":[function(require,module,exports) {
